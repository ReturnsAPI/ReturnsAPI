...
local find_table = P.class_find_tables["Item"]
...
for name, num in pairs(Item.Property) do Item.Property[num] = name end
...
Item.find = function(identifier, namespace, namespace_is_specified)
    check_init_started()
...
Item.find_all = function(NAMESPACE, filter, property)
...
methods.print = function(self)
    ...
    for i, v in ipairs(array) do
        str = str.."\n"..string.pad_right(Item.Property[i - 1], 32).." = "..tostring(v)
    end
    print(str)
end
...
Util.table_append(methods_content_class["Item"], {
