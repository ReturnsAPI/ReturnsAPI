...
Hook.internal.add = function(namespace, script, _type, fn, priority)
    ...
    -- * Prevent hooking builtin functions (not needed anymore)
    ...
    if not __hook_bank[script][_type] then
        ...
        or GM.internal.script[script] then
            ...
            local args_cast_type = __args_typed
            if is_script then args_cast_type = __args_typed_scr end
            ...
            hook_func = function(ret_val, result, self, other, arg_count, args)
                ...
                if self_address ~= 0 then
                    ...
                    -- Struct
                        ...
                        self_wrapped = Struct.wrap(memory.resolve_pointer_to_type(self_address, "YYObjectBase*"))
                ...
                if other_address ~= 0 then
                    ...
                    -- Struct
                        ...
                        other_wrapped = Struct.wrap(memory.resolve_pointer_to_type(other_address, "YYObjectBase*"))
