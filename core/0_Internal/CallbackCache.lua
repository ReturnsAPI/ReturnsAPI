...
callback_cache_mt = {
    __index = {
        ...
        remove_all = function(namespace)
            -- Loop through sections
            for _, section_table in ipairs(self.sections) do

                -- Loop through priority tables
                for priority, priority_table in ipairs(section_table) do
        ...
        loop_and_call_function = function(fn, section)
            section = section or "main"
            local section_table = self.sections[section]
